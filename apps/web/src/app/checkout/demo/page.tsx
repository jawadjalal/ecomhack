...
import { DEMO_CATALOG, formatPrice } from "@/lib/store-agent";
...
export default async function DemoCheckoutPage({ searchParams }: PageProps<"/checkout/demo">) {
  ...
  return <DemoCheckout offer={offer ? { id: offer.id, title: offer.title, description: offer.description, price: formatPrice(offer) } : undefined} refId={ref} />;
}
