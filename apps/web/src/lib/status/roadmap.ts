...
export const ROADMAP: RoadmapArea[] = [
  ...
  },
  {
    ...
    done: "Impact strip, conversion, A vs B, which agents buy and the funnel share one store snapshot with the chat. Group chats open as their own tabs (Pixel, Fizz, Dash by those names).",
    leftToDo: ["Both card rows above the fold at 1440×900", "Make the chat the lead agent on every screen, able to navigate and run any action", "Persist group-chat threads on the server"],
    ...
    nextIdeas: ["Point ?mock=1 chat at the same in-browser engine as the cards"],
  },
  {
    key: "issues",
    name: "Issues",
