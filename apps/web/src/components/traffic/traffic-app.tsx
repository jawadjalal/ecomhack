  ...
  return (
    <>
      <PageHead
        ...
        title="Traffic"
        lede="Where visitors come from, people or AI agents, and whether they buy."
        right={
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-[minmax(0,1.7fr)_minmax(0,1fr)]">
        <Card tone="yellow" shape="observer" corner="tr" className="p-5">
          <div className="flex flex-wrap items-end justify-between gap-x-8 gap-y-3">
            ...
            {t && t.synthetic > 0 && (
              <span title="Visitors generated by Darwin's simulators (properties.synthetic = true)" className="self-start">
                <Tag tone="white">
