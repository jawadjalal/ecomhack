  ...
  return (
    <span className={cn("group/tip relative inline-flex", className)}>
      ...
      <span
        role="tooltip"
        className={cn(
          "pointer-events-none absolute left-1/2 z-30 -translate-x-1/2 rounded-full bg-dw-ink px-2.5 py-1 text-[12px] leading-snug font-medium text-white opacity-0 shadow-[0_8px_20px_-8px_rgba(20,20,19,0.5)] transition-[opacity,translate] duration-200 group-focus-within/tip:opacity-100 group-hover/tip:opacity-100",
